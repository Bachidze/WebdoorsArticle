...
const Sponsor = ({Pirveli,Sharm, Saqartvelo,Tbilisi,Creatour,Kikala,NBR,Pitstop,QartuliSaqme,Proteller,Supta}:any) => {
  return (
    <>
    <section className='hidden xl:flex w-[90%] xl:flex-col xl:mt-[159px]  xl:m-auto'>
            <div className='flex justify-center flex-wrap gap-[80px] xl:mb-[60px] dashoreba'>
            ...
            <div className='flex justify-center m-auto gap-[80px] pb-[160px] mt-10 dashoreba'>
                <img src={NBR} alt="NBR" />
